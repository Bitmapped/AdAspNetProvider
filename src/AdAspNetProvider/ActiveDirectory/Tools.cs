...
namespace AdAspNetProvider.ActiveDirectory
{
    public class Tools
    {
        ...
        /// </summary>
        public ToolsConfiguration Config { get; set; }
        ...
        public Tools(string server, string username, string password)
            : this(new ToolsConfiguration { Server = server, Username = username, Password = password })
        { }
        ...
        public Tools(ToolsConfiguration configuration)
        {
