...
{
    public class AdServiceConfiguration
    {
        #region Constructor
        /// <summary>
        ...
        public AdServiceConfiguration(string connectionString = null, string username = null, string password = null)
        {
        ...
        public AdServiceConfiguration Clone()
        {
            return (AdServiceConfiguration)this.MemberwiseClone();
        }
    }
}
